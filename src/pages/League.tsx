...
function ridersFrom(members: LiveMember[], rides: LiveRide[], bonuses: PointAdjustment[]): LeagueRider[] {
  return members.map(member => {
    ...
    const elevation = own.reduce((total, ride) => total + ride.elevation_m, 0)

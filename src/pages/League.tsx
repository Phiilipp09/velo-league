...
export type LeagueRider = { id: string; name: string; points: number; elevation: number; kilometers: number; sprint: number; young: number; week: number; month: number; eligibleYoung: boolean }
